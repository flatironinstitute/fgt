...
c
c     Note: the tables in this file act directly on function values 
c     at Legendre nodes, while the tables in fgtvolrouts.f act on the Legendre
c     expansion coefficients.
c
c     last modified by Shidong Jiang on July 7, 2021
c
c
...
c
C*********************************************************************C
      subroutine mk_leg2pw(n,npw,nnodes,ws,ts,delta,boxdim,
     1    tab_leg2pw)
C*********************************************************************C
