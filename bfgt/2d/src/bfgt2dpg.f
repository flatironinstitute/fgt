...
c    $Revision$
      ...
      subroutine bfgt2dpg(nd,delta,eps,nboxes,nlevels,ltree,
     1   itree,iptr,norder,ncbox,ttype,fvals,centers,boxsize,npbox,
     2   pot,grad,timeinfo,tprecomp)
...
c
c
      subroutine bfgt2dpgmain(nd,delta,eps,nboxes,nlevels,ltree,
     1    itree,iptr,norder,ncbox,ttype,fvals,centers,boxsize,
     2    iaddr,rmlexp,npwlevel,pmax,npw,
     3    npbox,pot,grad,timeinfo)
