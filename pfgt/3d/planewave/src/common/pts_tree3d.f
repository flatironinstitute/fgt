...
c
      ...
      double precision src(3,ns),targ(3,nt),cen0(3),bs0
...
c--------------------------------------------------------------
c
      subroutine subdividebox_new(pos,npts,center,boxsize,
     1           isorted,iboxfl,subcenters)
      ...
      integer isorted(*)
      integer iboxfl(2,8)
      double precision centerstmp(3,9)
      integer iboxfltmp(2,9),ichild(8,9)
      integer nboxes
      integer i,ibox,ii,j,jj
      ...
      centerstmp(1,1) = center(1)
      centerstmp(2,1) = center(2)
      centerstmp(3,1) = center(3)
...
C$OMP END PARALLEL DO      
      ...
      do i=1,8
         ...
         centerstmp(1,i+1) = subcenters(1,i)
         centerstmp(2,i+1) = subcenters(2,i)
         centerstmp(3,i+1) = subcenters(3,i)
      enddo
      ibox = 1
      call sort_pts_to_children(ibox,nboxes,centerstmp,ichild,
...
c      
      ...
      real *8 src(3,ns),targ(3,nt),bs0,cen0(3)
