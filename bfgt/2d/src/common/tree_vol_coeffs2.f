...
c
     ...
     2  boxsize,nboxes,ifirstbox,nbloc,rsc,irefinebox,irefine)
      ...
      allocate(errtmp(nd),ftmp(nd,npols))

      


C$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(i,ibox,erra,errtmp,ftmp)
      do i=1,nbloc
        irefinebox(i) = 0
     ...
     1     iptype,rscale2,errtmp,ftmp,erra)
...
c
c
      subroutine fun_err(nd,n,fcoefs,rmask,iptype,rscale,errtmp,ftmp,
     1   erra)
