...
c
      ...
      if (ifuniform.eq.1) then
         open(iw, file='errorN3d.txt', position='append')
         open(iw2, file='timingN3d.txt', position='append')
      else
         open(iw, file='errorN3d.txt', position='append')
         open(iw2, file='timingN3d.txt', position='append')
      endif
...
c     
      ...
      do j=1,5
         write(iw2,*) nsrcs(j), pps(j,1), pps(j,2), pps(j,3), pps(j,4)
      enddo
