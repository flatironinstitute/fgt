...
c
c
      subroutine tens_prod_trans_nd(nd,norder,fvals,fcoefs,umat)
c
...
c
C*********************************************************************C
      subroutine gnd_tens_prod_to_pw(nd,n,coeff,npw,ff,tab_leg2pw,pwexp)
...
c
C*********************************************************************C
      subroutine gnd_pw2pot(nd,n,npw,pwexp,ff,tab_pw2pot,pot)
C*********************************************************************C
...
c
C*********************************************************************C
      subroutine gnd_tens_prod_to_potloc(nd,n,coeff,ff,pot,tabx,taby)
C*********************************************************************C
...
C
C*********************************************************************C
      subroutine gnd_tens_prod_to_potloc2(nd,n,coeff,ff,pot,
     1    tabx,taby,indx,indy)
C*********************************************************************C
c     This routine computes the volume Gauss transform over a 
c     single box source distribution given as a Legendre series.
c     The target points have a fixed location w.r.t. source box
...
C
C*********************************************************************
      subroutine mk_pw_translation_matrices(xmin,npw,ts,nmax,
     1              wshift)
C
...
c     
c
      subroutine mk_merge_split_pw_matrices(xmin,npw,ts,nmax,
     1           wshift)
C
...
c
C
      subroutine gnd_copypwexp(nd,nexp,pwexp1,
     1              pwexp2)
C
...
c
C*********************************************************************C
      subroutine gnd_pw2pg(nd,n,npw,pwexp,ff,ff2,tab_pw2pot,
...
c
C*********************************************************************C
      subroutine gnd_pw2pgh(nd,n,npw,pwexp,ff,ff2,ff3,tab_pw2pot,
