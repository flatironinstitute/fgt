...
c
c     g1dformsc_vec : computes the SOE expansion about the center CENT
c                     due to sources of strength charge()
c
c     g1dformsd_vec : computes the SOE expansion about the center CENT
c                     due to dipoles
c
c     g1dformscd_vec : computes the SOE expansion about the center CENT
c                     due to charges and dipoles
c
C     g1dsevalp_vec : evaluates the SOE expansion 
C                         potential only.
c      
C     g1dsevalg_vec : evaluates the SOE expansion 
C                         pot/grad
c      
C     g1dsevalh_vec : evaluates the SOE expansion 
C                         pot/grad/Hessian
c      
c     g1dshiftsoe_vec : shift one SOE expansion
c                     
c     g1dshiftsoeall_vec : shift all four SOE expansions
c
...
C
C*********************************************************************
      subroutine g1dformsc_vec(nd,delta,sources,ns,charge,center,
     1            nn,ws,ts,soeall)
C
...
C
      ...
      real *8 center,sources(ns),charge(nd,ns),pmax
      complex *16 soeall(2*nn/2,nd)
...
c
         do ind = 1,nd
            do j=1,nn/2
               wtall(j,ind) = ww1p(j,ind)
               wtall(nexp+j,ind) = ww1m(j1,ind)
            enddo
         enddo
c
         do ind=1,nd
...
C
C
      subroutine g1dformsd_vec(nd,delta,sources,ns,rnormal,dipstr,
...
C
C
      subroutine g1dformscd_vec(nd,delta,sources,ns,charge,
...
C
C*********************************************************************
      subroutine g1dsevalp_vec(nd,delta,center,nn,ws,ts,soeall,
     1              targ,ntarg,pot)
C
...
C
C
      subroutine g1dsevalg_vec(nd,delta,center,nn,ws,ts,soeall,
...
c
c
      subroutine g1dsevalh_vec(nd,delta,center,nn,ws,ts,soeall,
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc      
      subroutine g1dsevalp0_vec(nd,delta,center,nn,ws,ts,soeall,
     1              targ,ntarg,pot)
C
C     This subroutine evaluates all SOE expansions about
C     CENT at location TARG.
...
c      
c      
      subroutine g1dsevalg0_vec(nd,delta,center,nn,ws,ts,soeall,
     1              targ,ntarg,pot,grad)
C
C     This subroutine evaluates all SOE expansions about
C     CENTER at location TARG.
...
C
C
      subroutine g1dsevalh0_vec(nd,delta,center,nn,ws,ts,soeall,
     1              targ,ntarg,pot,grad,hess)
C
C     This subroutine evaluates all SOE expansions soeall about
C     CENTER at location TARG
...
C      
C            
      subroutine g1dshiftsoe_vec(nd,nn,soeall1,
     1              soeall2,wshift,ip)
C
...
C
      ...
      complex *16 soeall1(2*nn/2,nd)
      complex *16 soeall2(2*nn/2,nd)
      complex *16 wshift(nn/2)
C
      nexp = nn/2
      do ind=1,nd
         do j=1,nexp
...
c
      ...
      do n=1,nmax
         do j=1,nsoe/2
c           + p          
            wshift(j,1,n) = wwp(j,n)
            wshift(j+nexp,1,n) = wwm(j,n)
c           - m           
            wshift(j,2,n) = wwm(j,n)
            wshift(j+nexp,2,n) = wwp(j,n)
         enddo
      enddo
...
C      
C                  
      subroutine g1dshiftsoeall_vec(nd,nn,soeall1,
     1              soeall2,wshift)
C
...
C      
c
      subroutine g1dshiftall_vec(nd,nexp,soeall1,soeall2,wshift)
C
...
C     soeall1  = original expansion FFEXP
C     wshift  = precomputed translation matrix
c      
C     OUTPUT:
C
...
C
      ...
      complex *16 soeall1(nexp,nd)
      complex *16 soeall2(nexp,nd)
...
C
C***********************************************************************
      subroutine g1dsoezero_vec(nd,soeall,nsoe)
      implicit none
C***********************************************************************
c
