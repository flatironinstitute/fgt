...
c     minus sign for sources
      ...
      if (dim.eq.1) then
         call finufft1d1many(ntrans,ns8,xj,cj,iflag,eps,npw8,
     1       fk,opts,ier)
      elseif (dim.eq.2) then
         call finufft2d1many(ntrans,ns8,xj,yj,cj,iflag,eps,npw8,
     1       npw8,fk,opts,ier)
      elseif (dim.eq.3) then
         call finufft3d1many(ntrans,ns8,xj,yj,zj,cj,iflag,eps,npw8,
     1       npw8,npw8,fk,opts,ier)
      endif
...
C*********************************************************************
     ...
     1    nexp,wnufftgh,pwexp,targ,nt,ifpgh,pot,grad,hess)
C
